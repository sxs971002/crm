...
public interface OrderDao {
	...
	@Insert("insert into c_order(clientid,createdate,performdate,orderdate,startdate,enddate,infos,createuserid,files,performuserids,performweight,statu,totalprice,comments) values(#{name},#{createdate},#{performdate},#{orderdate},#{startdate},#{enddate},#{infos},#{createuserid},#{files},#{performuserids},#{performweight},#{statu},#{totalprice},#{comments})")
